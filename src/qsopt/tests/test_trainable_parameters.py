...
class TestParameterConstraints:
    ...
    def test_custom_initialization(self):
        ...
        constraints = ParameterConstraints(min_value=-1.0, max_value=1.0, periodic=True, period=2.0)
...
class TestTrainableParameters:
    ...
    def test_trainable_flag_multiple_parameters_mixed(self):
        ...
        params.add_rotation_angles(
            ["theta1", "theta2", "theta3"], [1.0, 2.0, 3.0], trainable=[True, False, True]
        )
    ...
    def test_repr_with_fixed_parameters(self):
        ...
        params.add_rotation_angles(["theta1", "theta2"], [1.0, 2.0], trainable=[True, False])
