...
class TestOptimizationConfig:
    ...
    def test_custom_initialization(self):
        ...
        config = OptimizationConfig(
            ...
            update_frequency=2, lr_scheduler=scheduler
        )
...
class TestParameterGroup:
    ...
    def test_str_representation(self):
        ...
        group = ParameterGroup("angles", ParameterType.ROTATION_ANGLE, [0.0, 1.57], 
                             constraints=constraints, fixed_indices=[0])
        str_repr = str(group)
...
class TestTrainableParameters:
    ...
    def test_add_parameter_group(self):
        ...
        params = TrainableParameters()
        params.add_parameter_group("group1", ParameterType.ROTATION_ANGLE, [0.0, 1.0])
    ...
    def test_add_duplicate_group(self):
        ...
        params = TrainableParameters()
        params.add_parameter_group("group1", ParameterType.CUSTOM, [1.0])
        
        with pytest.raises(ValueError, match="Parameter group 'group1' already exists"):
            params.add_parameter_group("group1", ParameterType.CUSTOM, [2.0])
    
    def test_add_parameter_group_with_fixed_indices(self):
        """Test adding parameter group with fixed indices."""
        params = TrainableParameters()
        params.add_parameter_group("group1", ParameterType.CUSTOM, [1.0, 2.0, 3.0], fixed_indices=[0, 2])
    ...
    def test_get_parameter_group(self):
        ...
        params = TrainableParameters()
        params.add_parameter_group("test", ParameterType.CUSTOM, [1.0])
    ...
    def test_parameter_vector_operations(self):
        ...
        params = TrainableParameters()
        params.add_parameter_group("group1", ParameterType.CUSTOM, [1.0, 2.0])
        params.add_parameter_group("group2", ParameterType.CUSTOM, [3.0])
    ...
    def test_set_parameter_vector_wrong_size(self):
        ...
        params = TrainableParameters()
        params.add_parameter_group("test", ParameterType.CUSTOM, [1.0, 2.0])
        
        with pytest.raises(ValueError, match="Parameter vector length 3 doesn't match expected length 2"):
            params.set_parameter_vector(jnp.array([1.0, 2.0, 3.0]))
    
    def test_get_parameter_by_type(self):
        """Test parameter retrieval by type."""
        params = TrainableParameters()
        params.add_parameter_group("angles1", ParameterType.ROTATION_ANGLE, [0.0, 1.0])
        params.add_parameter_group("custom1", ParameterType.CUSTOM, [2.0])
        params.add_parameter_group("angles2", ParameterType.ROTATION_ANGLE, [3.0])
    ...
    def test_get_measurement_times(self):
        ...
        params = TrainableParameters()
        params.add_parameter_group("times", ParameterType.MEASUREMENT_TIME, [1.0, 2.0])
    ...
    def test_copy(self):
        ...
        params = TrainableParameters()
        params.add_parameter_group("group1", ParameterType.CUSTOM, [1.0, 2.0], fixed_indices=[0])
    ...
    def test_str_representation(self):
        ...
        params.add_parameter_group("group1", ParameterType.ROTATION_ANGLE, [0.0, 1.0])
        params.add_parameter_group("group2", ParameterType.CUSTOM, [2.0])
