...
from qsopt.core.circuit import (
    QuantumCircuit, GateApplication,
    create_layer, create_entangling_layer
)
...
class TestParameterManagement:
    ...
    def test_set_trainable_parameters(self):
        ...
        # Update parameters
        new_params = {
            "gate_0_theta": jnp.array(1.5),
            "gate_1_theta": jnp.array(2.5)
        }
...
class TestCircuitVsQuTiP:
    ...
    def test_single_qubit_rotations(self):
        ...
        for theta in angles:
            ...
            np.testing.assert_allclose(U_custom.full(), U_qutip.full(), 
