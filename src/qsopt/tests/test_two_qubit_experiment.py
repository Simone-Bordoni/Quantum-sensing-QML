...
def two_qubit_params():
    ...
    noise_config = NoiseConfiguration(depolarizing=[0.0, 0.0], dephasing=[0.0, 0.0], relaxation=[0.0, 0.0])
...
def test_simulation_runs(experiment):
    ...
    prob = experiment.simulation(
        solver=solver, rho=rho0,
        theta1_q1=0.0, theta2_q1=0.0,
        theta1_q2=0.0, theta2_q2=0.0,
