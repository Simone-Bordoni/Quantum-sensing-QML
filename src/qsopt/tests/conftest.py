...
def custom_experimental_parameters():
    ...
    from qsopt.core.experimental_parameters import (
        ExperimentalParameters, PhysicalConstants, SystemDimensions, MeasurementProtocol, InitialStateConfig, InitialStateType, NoiseConfiguration
    )
    
    constants = PhysicalConstants(
        chi=1.0,
        photon_cavity_coupling=0.5,
