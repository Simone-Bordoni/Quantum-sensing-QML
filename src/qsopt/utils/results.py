...
class TimeEvolutionResults:
    ...
    def __str__(self) -> str:
        ...
        lines.append(f"  Pulse shape: {'Available' if self.pulse_shape is not None else 'Not available'}")
    ...
    def __repr__(self) -> str:
        ...
        return (f"TimeEvolutionResults(times=array({len(self.times)} points), "
...
class SweepResults:
    ...
    def __str__(self) -> str:
        ...
        if 'optimal_chi' in self.metadata and 'optimal_gamma' in self.metadata:
            lines.append(f"  Optimal point: {self.param2_name}={self.metadata['optimal_chi']:.3g}, "
    ...
    def __repr__(self) -> str:
        """Return a detailed string representation for debugging."""
        return (f"SweepResults(param1_name='{self.param1_name}', param2_name='{self.param2_name}', "
